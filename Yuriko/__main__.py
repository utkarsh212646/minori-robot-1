...
yurikorobot_IMG = "http://telegra.ph//file/ed42d24647c75e822ea2d.jpg"

PM_START_TEXT = """
*👋 Hello {} !*

✗ *I'Aᴍ Aɴ Aɴɪᴍᴇ-Tʜᴇᴍᴇ Mᴀɴᴀɢᴇᴍᴇɴᴛ Bᴏᴛ*
✗ *Aᴍ Vᴇʀʏ Fᴀꜱᴛ Aɴᴅ  Mᴏʀᴇ Eꜰꜰɪᴄɪᴇɴᴛ  I Pʀᴏᴠɪᴅᴇ Aᴡᴇꜱᴏᴍᴇ  Fᴇᴀᴛᴜʀᴇꜱ and Mintained by @DARK_LEGEND088 and Owner @Allenspark10!*
────────────────────────
× *Uᴘᴛɪᴍᴇ:* `{}`
× `{}` *Uꜱᴇʀ, Aᴄʀᴏꜱꜱ* `{}` *Cʜᴀᴛꜱ.*
────────────────────────
...
buttons = [
    ...
    [
        InlineKeyboardButton(text="🌸Add Minori to your group🌸", url="http://t.me/minori_robot?startgroup=true"),
    ],
]
...
def yurikorobot_about_callback(update, context):
    ...
    if query.data == "yurikorobot_":
        query.message.edit_text(
            text=""" *Hinami* - `A bot to manage your groups with additional features!`
            \n`Here the basic help regarding use of HinamiRobot.`
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Bᴜɢ'ꜱ", url="t.me/Hinami_Support"
                        ),
                        InlineKeyboardButton(
                            text="Bᴏᴛ Lɪꜱᴛ", url="https://t.me/HINAMIUPDATES"
                        ),
                    ],
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Than send` `/admincache@HinamiChanRobot` `in that chat to refresh admin list in My database.`\n"
        ...
        query.message.edit_text(
            ...
            f"\n✗ `Congragulations, HinamiRobot now ready to manage your group.`"
            f"\n\n*Admin Tools*"
